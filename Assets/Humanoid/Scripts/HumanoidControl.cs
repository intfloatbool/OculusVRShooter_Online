...
namespace Passer {
    ...
    public class HumanoidControl : MonoBehaviour {
        ...
        private float _avatarNeckHeight;

        public float avatarNeckHeight
        {
            get { return _avatarNeckHeight; }
            set
            {
                _avatarNeckHeight = value;
                Debug.Log($"{gameObject.name.ToUpper()}: Avatar neckHeight changed to: {value} !");
            }
        }
        ...
        public bool IsTranslateByPhysics = false;
        ...
        [SerializeField] private bool _isUsePulling;

        public bool IsUsePulling
        {
            get => _isUsePulling;
            set => _isUsePulling = value;
        }

        private bool _isActiveControl = true;
        public bool IsActiveControl
        {
            get => _isActiveControl;
            set => _isActiveControl = value;
        }
        ...
        public void SetTrackingHeightToAvatar() {
            ...
            //localNeckHeight - высота шеи от пола
            float deltaY = avatarNeckHeight - localNeckHeight;
            //deltaY - разница роста игрока и шеи 
            
            //Меняем позицию головые игрока в мире
        ...
        private void CalculateMovement() {
            ...
            {
                Debug.Log("TanslationVector change Y!: " + translationVector);
            }
            //END-DEBUG
            ...
            if (targetVelocity.y != 0) {
                ...
                //DEBUG
                Debug.Log("targetVelocity change Y !: " + targetVelocity);
                //END-DEBUG
            }
        }
